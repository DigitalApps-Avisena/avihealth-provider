...
class Admission extends StatefulWidget {
  const Admission({Key? key, required this.locationCode}) : super(key: key);
      ...
      body: loading
        ...
        child: ListView(
          children: [
            ...
            ...((admissionData!['listPatient'] as List? ?? []).map((wardData) {
